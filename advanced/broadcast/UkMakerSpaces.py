...
def loadPostCodeMap():
    lines = open("C:/Users/Seyhun Altunbay/Documents/Python-Spark/python-spark-tutorial/in/uk-postcode.csv", "r").read().split("\n")
...
if __name__ == "__main__":
    ...
    makerSpaceRdd = sc.textFile("C:/Users/Seyhun Altunbay/Documents/Python-Spark/python-spark-tutorial/in/uk-makerspaces-identifiable-data.csv")
