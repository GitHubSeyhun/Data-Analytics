...
if __name__ == "__main__":
    ...
    session = SparkSession.builder.appName("StackOverFlowSurvey")\
        .master("local[*]")\
        .getOrCreate()
    sc = session.sparkContext

    lines = sc.textFile("C:/Users/Seyhun Altunbay/Documents/Python-Spark/python-spark-tutorial/in/2016-stack-overflow-survey-responses.csv")
