...
if __name__ == "__main__":
    ...
    makerSpace = session.read.option("header", "true") \
        .csv("C:/Users/Seyhun Altunbay/Documents/Python-Spark/python-spark-tutorial/in/uk-makerspaces-identifiable-data.csv")

    postCode = session.read.option("header", "true").csv("C:/Users/Seyhun Altunbay/Documents/Python-Spark/python-spark-tutorial/in/uk-postcode.csv") \
